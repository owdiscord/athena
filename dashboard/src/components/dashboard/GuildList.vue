      ...
      <li v-for="guild in guilds" class="flex-none p-4 w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
        <div class="flex items-center">
          <div class="flex-none w-12 h-12">
            <img v-if="guild.icon" class="rounded-full w-full h-full" :src="guild.icon" alt=""
          ...
          <div class="flex-auto ml-4">
            ...
            <div class="pt-1">
              <router-link class="inline-block bg-gray-700 rounded px-1 hover:bg-gray-800"
                :to="'/dashboard/guilds/' + guild.id + '/config'">Config</router-link>
...
import type { AuthState, GuildState } from "../../store/types";
